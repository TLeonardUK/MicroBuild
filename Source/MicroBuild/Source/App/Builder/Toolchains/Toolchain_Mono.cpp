...
Toolchain_Mono::Toolchain_Mono(ProjectFile& file)
	: Toolchain(file)
{
}

bool Toolchain_Mono::CompilePch(BuilderFileInfo& fileInfo) 
{
...
bool Toolchain_Mono::Compile(BuilderFileInfo& fileInfo, BuilderFileInfo& pchFileInfo)
{
	MB_UNUSED_PARAMETER(fileInfo);
