...
#include "MicroBuild-Zlib/Source/zlib.h"
#include "FreeImage.h"
#include "Utilities.h"
#include "MicroBuild-Zlib/Source/zutil.h"	/* must be the last header because of error C3163 in VS2008 (_vsnprintf defined in stdio.h) */
