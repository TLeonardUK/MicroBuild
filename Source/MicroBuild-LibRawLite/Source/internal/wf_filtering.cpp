...
#define WF_i_1TO4 for(int i=0; i<4; i++)
	...
	float dfg_mult[WF_GAUSS_PIRAMID_SIZE]={1.560976f, 8.196011f, 180.413773f, 3601.427246f/3.0f};
...
/*	dif_mult[0]=1.0/wf_filter_energy(0, 0,   0,    1);
	...
	float dfg_mulg[WF_GAUSS_PIRAMID_SIZE]={1.235223f, 19.813868f, 365.148407f, 7208.362793f/3.0f};
